                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () => setState(() => selectedDuration = "5s"),
                          child: _dropOption("5s",
                              selected: selectedDuration == "5s"),
                        ),
                        GestureDetector(
                          onTap: () => setState(() => selectedDuration = "10s"),
                          child: _dropOption("10s",
                    ...
                    Wrap(
                      ...
                      runSpacing: 12,
                      children: [
                        _dropOptionWithIcon("16:9"),
                        _dropOptionWithIcon("9:16"),
                        _dropOptionWithIcon("1:1"),
                      ],
                    ),
                  ],
                ),
